...
1 degree F = 4--10 days earlier (*p = 0.017*); temperature data from Camino CIMIS station.
...
R code for this analysis can be found on Github <a href="https://github.com/codeswitching/Reservoir-inflow-analysis/tree/master">here</a>.